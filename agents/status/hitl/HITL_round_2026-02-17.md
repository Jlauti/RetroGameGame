...
3. Build once:
   ...
   - Guardrailed local path: `cargo build --bin retro-game-game`

## Launch

1. Run game:
   - Strong machine path: `cargo run --bin retro-game-game`
   - Guardrailed local path: `cargo run --bin retro-game-game`
...
3. Orientation offset runtime wiring
   ...
   - Edit `c:\Users\jlaut\git\RetroGameGame/specs/future/nebula_bouncer/sprite_orientation.json`, relaunch, press `F8` again.
