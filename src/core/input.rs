...
fn update_game_input(
    ...
    input.just_up = keyboard.just_pressed(KeyCode::KeyW)
        || keyboard.just_pressed(KeyCode::ArrowUp);
    input.just_down = keyboard.just_pressed(KeyCode::KeyS)
        || keyboard.just_pressed(KeyCode::ArrowDown);
    input.just_left = keyboard.just_pressed(KeyCode::KeyA)
        || keyboard.just_pressed(KeyCode::ArrowLeft);
    input.just_right = keyboard.just_pressed(KeyCode::KeyD)
        || keyboard.just_pressed(KeyCode::ArrowRight);

    // Actions
    input.confirm = keyboard.just_pressed(KeyCode::Enter)
        || keyboard.just_pressed(KeyCode::Space);
    input.cancel = keyboard.just_pressed(KeyCode::Escape);
    input.action_a = keyboard.just_pressed(KeyCode::Space);
    input.action_b = keyboard.just_pressed(KeyCode::ShiftLeft)
